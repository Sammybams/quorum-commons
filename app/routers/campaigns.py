...
def _contribution_out(db: MongoStore, contribution: models.Contribution) -> schemas.ContributionOut:
    ...
    return schemas.ContributionOut(
        ...
        provider=contribution.get("provider") or contribution.get("method"),
        gateway_ref=contribution.get("gateway_ref"),
        provider_transaction_ref=contribution.get("provider_transaction_ref"),
        virtual_account_number=contribution.get("virtual_account_number"),
        account_name=contribution.get("account_name"),
        bank_name=contribution.get("bank_name"),
        expires_at=contribution.get("expires_at"),
