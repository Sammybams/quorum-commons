...
def create_member(
    ...
    membership = db.insert(
        "workspace_members",
        {
            ...
            "opportunity_preferences": payload.opportunity_preferences,
...
def _member_out(db: MongoStore, membership: models.WorkspaceMember) -> schemas.WorkspaceMemberOut:
    ...
    return schemas.WorkspaceMemberOut(
        ...
        languages=membership.get("languages") or [],
        availability=membership.get("availability"),
        opportunity_preferences=membership.get("opportunity_preferences") or [],
        contribution_capacity=membership.get("contribution_capacity"),
